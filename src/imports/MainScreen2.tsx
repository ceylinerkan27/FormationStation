import svgPaths from "./svg-svuam5ptsz";
  ...
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="notes">
      ...
      <div className="absolute flex h-[74px] items-center justify-center left-[176px] top-[210px] w-[25px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <p className="font-['Inter:Bold',sans-serif] font-bold h-[25px] leading-[19.5px] not-italic relative text-[#b4b1b1] text-[20px] tracking-[0.52px] w-[74px]">Notes</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="notes filled in">
      ...
      <div className="absolute flex h-[221px] items-center justify-center left-[224px] top-[63px] w-[83px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <p className="font-['Inter:Bold',sans-serif] font-bold h-[83px] leading-[19.5px] not-italic opacity-0 relative text-[#b4b1b1] text-[18px] tracking-[0.52px] w-[221px]">anne lets bob move first and then goes around carl</p>
        </div>
      </div>
      <div className="absolute flex h-[74px] items-center justify-center left-[176px] top-[210px] w-[25px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <p className="font-['Inter:Bold',sans-serif] font-bold h-[25px] leading-[19.5px] not-italic opacity-0 relative text-[#b4b1b1] text-[20px] tracking-[0.52px] w-[74px]">Notes</p>
        </div>
      </div>
    </div>
  );
...
function Stage() {
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="stage">
      <Notes />
      <NotesFilledIn />
      <div className="absolute flex h-[884px] items-center justify-center left-[165px] top-[391px] w-[624px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <Frame1 />
        </div>
      </div>
...
function TimeTicNums() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[128px] h-[727px] items-center justify-end left-[876px] top-[225px] w-[13px]" data-name="time tic nums">
      <div className="flex h-[46px] items-center justify-center relative shrink-0 w-[18px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative text-[#b4b1b1] text-[15px] text-center whitespace-nowrap">
      ...
      <div className="flex h-[45px] items-center justify-center relative shrink-0 w-[18px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative text-[#b4b1b1] text-[15px] text-center whitespace-nowrap">
      ...
      <div className="flex h-[43px] items-center justify-center relative shrink-0 w-[18px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative text-[#b4b1b1] text-[15px] text-center whitespace-nowrap">
...
function Span1() {
  return (
    <div className="absolute h-[19.5px] left-0 top-[3.25px] w-[90.732px]" data-name="span">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[19.5px] left-0 not-italic text-[#999] text-[13px] top-[-0.43px] whitespace-nowrap">path edit mode</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">Formation 1</p>
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#3a3a3a] border-[0.571px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">Formation 2</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#3a3a3a] border-[0.571px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">Formation 3</p>
      </div>
    </div>
  );
}
...
export default function MainScreen() {
  return (
    <div className="bg-[#1d1d1d] relative size-full" data-name="main screen-2" style={{ containerType: "size" }}>
      <Stage />
      <TopBar />
      <FormationsBottomBar />
