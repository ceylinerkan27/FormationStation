import svgPaths from "./svg-2c8dwbm2ib";
...
function Notes() {
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="notes">
      <div className="absolute flex h-[250px] items-center justify-center left-[165px] top-[48px] w-[624px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="bg-[#28292a] h-[624px] rounded-[16px] w-[250px]" data-name="notes" />
        </div>
      </div>
      <div className="absolute flex h-[74px] items-center justify-center left-[176px] top-[210px] w-[25px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
...
function NotesFilledIn() {
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="notes filled in">
      <div className="absolute flex h-[250px] items-center justify-center left-[165px] top-[48px] w-[624px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="bg-[#28292a] h-[624px] opacity-0 rounded-[16px] w-[250px]" data-name="notes" />
        </div>
      </div>
      <div className="absolute flex h-[221px] items-center justify-center left-[224px] top-[63px] w-[83px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
...
function Frame2() {
  return (
    <div className="absolute bg-[#8b72be] left-[130px] rounded-[100px] size-[75px] top-[399px]">
...
function Frame3() {
  return (
    <div className="absolute bg-[#8b72be] left-[290px] rounded-[100px] size-[75px] top-[285px]">
      <div className="overflow-clip relative rounded-[inherit] size-full">
...
function Stage() {
  return (
    <div className="absolute contents left-[165px] top-[48px]" data-name="stage">
      <Notes />
      <NotesFilledIn />
      <div className="absolute flex h-[884px] items-center justify-center left-[165px] top-[391px] w-[624px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "42" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <Frame1 />
        </div>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[188px] items-center justify-center left-[810px] top-[833px] w-[42px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
      ...
      <div className="-translate-y-1/2 absolute flex h-[128.404px] items-center justify-center left-[37px] top-[948.56px] w-[6.825px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[6.825px] justify-center leading-[0] not-italic relative text-[13px] text-white w-[128.404px]">
            <p className="leading-[normal]">formation 1</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame4() {
  return (
    <div className="h-[28px] relative rounded-[5px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[11px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.2)] whitespace-nowrap">search for number of dancers!</p>
        </div>
      </div>
...
function Container7() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#333] border-b-[0.571px] border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[12px] py-[16px] relative w-full">
        <Frame4 />
      </div>
    </div>
  );
...
function Container9() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#3a3a3a] border-[0.571px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">10 Dancers</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#3a3a3a] border-[0.571px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">9 Dancers</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="bg-[#2e2e2e] h-[42.143px] relative rounded-[8px] shrink-0 w-[255.429px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#3a3a3a] border-[0.571px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[12.57px] not-italic text-[#ccc] text-[14px] top-[9.71px] whitespace-nowrap">13 Dancers</p>
      </div>
    </div>
  );
}
...
function SearchContainer() {
  return (
    <div className="bg-[#252525] content-stretch flex flex-col h-[709.429px] items-start pr-[0.571px] relative rounded-[7px] w-[280px]" data-name="search-container">
      <div aria-hidden="true" className="absolute border-[#333] border-r-[0.571px] border-solid inset-0 pointer-events-none rounded-[7px]" />
      <Container7 />
      <Container8 />
    </div>
...
export default function MainScreen() {
  return (
    <div className="bg-[#1d1d1d] relative size-full" data-name="main screen-3" style={{ containerType: "size" }}>
      <TopBar />
      <Stage />
      <FormationsBottomBar />
      ...
      <div className="absolute flex h-[280px] items-center justify-center left-[133px] top-[1063px] w-[709.429px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "85" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <SearchContainer />
        </div>
      </div>
